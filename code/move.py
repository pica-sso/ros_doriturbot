...
if __name__ == '__main__':
    goal_positions_x = [0.218, 0.583, 0.916, 1.384,1.558 ]
    goal_positions_y = [0.197, 1.553, 0.910, 0.317,1.852]

    goal_pose_z = [0.694, -0.002, -0.724,0.652,0.670]
    goal_pose_w = [0.720, 0.999, 0.690, 0.7578,0.742]
